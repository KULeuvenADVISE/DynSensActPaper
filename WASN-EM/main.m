...
proc{1}.method = 'ADC';
%proc{1}.method = 'FE/MFCCddd_mustd'; % name of the first processing chain (typically FE). if no FE => 'FE/ADC'
%proc{2}.method = 'NN/Softmax_example'; % name of second processing chain (typically classifier) or remove line
